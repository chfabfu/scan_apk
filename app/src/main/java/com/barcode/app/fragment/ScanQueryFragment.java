...
public class ScanQueryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_scan_query, container, false);
    }
    ...
    private void onBarcodeResult(String barcode) {
        ...
        if (product != null) {
            ...
            Toast.makeText(requireContext(), "未录入该商品（条形码：" + barcode + "）",
